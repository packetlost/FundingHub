...
var contracts_directory = path.join("./", "contracts");
fs.readdirSync("./contracts").forEach(function(file) {
...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      { test: /\.scss|css$/, loader: ExtractTextPlugin.extract("style-loader", "css-loader") },
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      ...
      { from: './app/javascripts/json', to: "json" }
    ]),
